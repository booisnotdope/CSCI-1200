...
Nick Wang, helped me create ideas for full just
stackoverflow, geeks for geeks. learned about .count(), .find(), .substr().
...
the error output code I copied from submitty doesn't work. It creates new text files even when I don't want to. 
