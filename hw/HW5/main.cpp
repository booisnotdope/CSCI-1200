...
void StudentTests() {
  ...
  TrainCar* train1 = NULL;
  TrainCar* train2 = NULL;
  PushBack(train1, TrainCar::MakeEngine());
  PushBack(train1, TrainCar::MakeEngine());
  PushBack(train1, TrainCar::MakeEngine());
  PushBack(train1, TrainCar::MakeEngine());
  PushBack(train1, TrainCar::MakeEngine());
  ...
  MTRand_int32 mtrand_autoseed(time(NULL));
  for(int i = 0; i < 10; i++){
    ShipFreightHelper(mtrand_autoseed, 3 + i, 20, 65, 10);
  }

  PushBack(train1, TrainCar::MakeEngine());
  PushBack(train1, TrainCar::MakePassengerCar());
  PushBack(train1, TrainCar::MakePassengerCar());
  PushBack(train1, TrainCar::MakePassengerCar());
  PushBack(train1, TrainCar::MakePassengerCar());
  PushBack(train1, TrainCar::MakePassengerCar());
